...
from src.routers import itinerary_locations, itinerary_members, users, itineraries, files
...
app.include_router(itinerary_locations.router, prefix="/api/itinerary_locations", tags=["itinerary locations"])
